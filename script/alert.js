...
!function($){
	...
	$.confirm=function(){
        ...
        _click()
			...
			d = $('<div class="alert_overlay '+($._ismob?'mob':'pc')+'"><div class="alert_msg"><div class="alert_content">'+args[0]+'</div></div></div>')
			.on('contextmenu',!1)
